            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="{{ url('/admins') }}" class="btn btn-sm btn-success">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/admins/'.$admin->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cedula" class="form-control" value="{{ old('cedula', $admin->cedula) }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-warning">Solo llena el campo si desea campo si desea cambiar la contraseña</small>
                    </div>
